                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('periksa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="id_pasien" name="id_pasien" class="form-select @error('id_pasien') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="id_obat" name="id_obat" class="form-select @error('obat') is-invalid @enderror" required>
